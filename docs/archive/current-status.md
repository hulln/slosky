...
- `141,013` posts
- composition documented in [methodology-decision.md](methodology-decision.md)
...
- [strict_review_validation_sample_annotated.csv](../../outputs/validated/strict_review_validation_sample_annotated.csv)
- [strict_review_validation_summary.json](../../outputs/validated/strict_review_validation_summary.json)
...
- [validation-results.md](../paper/validation-results.md)
- QA summary: [quality-assurance.md](../paper/quality-assurance.md)
- machine-readable QA audit: [final_corpus_audit.json](../../outputs/validated/final_corpus_audit.json)
- detector comparison: [detector-choice.md](../paper/detector-choice.md)
...
- current corpus decision: [methodology-decision.md](methodology-decision.md)
- paper-style methodology wording: [methodology-section-draft.md](../paper/methodology-section-draft.md)
- chronological documentation: [process-log.md](process-log.md)
...
- earlier fastText/Lingua exploratory files were kept under `outputs/legacy/` in previous repo states
...
1. [seed_author_live.sqlite](../../outputs/running/seed_author_live.sqlite)
   - live collection from known Slovene-linked accounts
2. [atproto_discovery_backfill.sqlite](../../outputs/running/atproto_discovery_backfill.sqlite)
   - slow network-wide historical tagged discovery
3. [atproto_discovery_live.sqlite](../../outputs/running/atproto_discovery_live.sqlite)
   - inactive/resumable live tagged discovery store
4. [pds_cache.json](../../outputs/running/pds_cache.json)
